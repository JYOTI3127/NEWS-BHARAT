...
class Article(models.Model):
    ...
    schema_article_section = models.CharField(max_length=150, blank=True, default='')
    schema_keywords = models.CharField(max_length=500, blank=True, default='')
    schema_author_name = models.CharField(max_length=150, blank=True, default='')
    schema_author_url = models.URLField(blank=True, default='')
    schema_image_url = models.URLField(blank=True, default='')
    schema_publisher_name = models.CharField(max_length=150, blank=True, default='')
    schema_publisher_logo_url = models.URLField(blank=True, default='')
    schema_organization_type = models.CharField(max_length=100, blank=True, default='')
    schema_organization_sameas = models.JSONField(default=list, blank=True)
