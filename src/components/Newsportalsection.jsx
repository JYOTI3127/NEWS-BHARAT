...
const healthNews = [
  ...
  { id: 6, img: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=200&q=80", text: "लोरेम इप्सम उद्योग का मानक डमी टेक्स्ट रहा है। यह न केवल पांच शताब्दियों तक जीवित रहा है" },
  { id: 7, img: "https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=200&q=80", text: "लोरेम इप्सम उद्योग का मानक डमी टेक्स्ट रहा है। यह न केवल पांच शताब्दियों तक जीवित रहा है" },
  { id: 8, img: "https://images.unsplash.com/photo-1505751172876-fa1923c5c528?w=200&q=80", text: "लोरेम इप्सम उद्योग का मानक डमी टेक्स्ट रहा है। यह न केवल पांच शताब्दियों तक जीवित रहा है" },
];
    ...
    <div style={{ marginBottom: "22px" }}>
      ...
      <div style={{ display: "flex", gap: "14px", alignItems: "flex-start" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px", width: "310px", flexShrink: 0 }}>
            <div style={{
              ...
              <div style={{
                ...
                <p style={{ color: "#fff", fontSize: "13px", fontWeight: 600, lineHeight: 1.5, fontFamily: "'Noto Sans Devanagari','Arial',sans-serif" }}>
            ...
            <div style={{ display: "flex", gap: "10px", alignItems: "flex-start", cursor: "pointer" }}>
              <div style={{ width: "130px", minWidth: "130px", height: "86px", borderRadius: "5px", overflow: "hidden", flexShrink: 0, background: "#222" }}>
                <img src="https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=400&q=80" alt="concert"
                  style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
              </div>
              <div style={{ flex: 1, minWidth: 0 }}>
                <p style={{ fontSize: "12px", fontWeight: 500, color: "#1a1a1a", lineHeight: 1.6, fontFamily: "'Noto Sans Devanagari','Arial',sans-serif",
          ...
          <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: "12px" }}>
            {entMidCards.map((card) => (
              <div key={card.id} style={{ display: "flex", gap: "10px", alignItems: "flex-start", cursor: "pointer" }}>
                <div style={{ position: "relative", width: "175px", minWidth: "175px", height: "108px", borderRadius: "5px", overflow: "hidden", flexShrink: 0, background: "#222" }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <p style={{ fontSize: "12.5px", fontWeight: 500, color: "#1a1a1a", lineHeight: 1.6, fontFamily: "'Noto Sans Devanagari','Arial',sans-serif",
                    display: "-webkit-box", WebkitLineClamp: 5, WebkitBoxOrient: "vertical", overflow: "hidden" }}>{card.title}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div style={{ width: "210px", minWidth: "195px", flexShrink: 0, background: "#fff", borderRadius: "5px", overflow: "hidden", boxShadow: "0 1px 6px rgba(0,0,0,0.09)" }}>
          ...
          <div style={{ maxHeight: "360px", overflowY: "auto", padding: "4px 8px", scrollbarWidth: "thin", scrollbarColor: "#e8001c #f5f5f5" }}>
            {healthNews.map((item, i) => (
              ...
              >
                ...
                <p style={{ fontSize: "10px", color: "#333", lineHeight: 1.45, fontWeight: 400, fontFamily: "'Noto Sans Devanagari','Arial',sans-serif",
