...
import {
  ...
  CheckCircle, ArrowRight, Send, X, Briefcase, ChevronDown, MapPin, Clock,
} from "lucide-react";
          ...
          <div className="cp-modal-body">
            <div className="cp-form-row">
              <div className="cp-form-group">
                ...
                <input className={`cp-form-input${errors.name ? " cp-err" : ""}`} placeholder="Your full name" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} />
            ...
            <div className="cp-form-row">
              <div className="cp-form-group">
                ...
                <input className="cp-form-input" placeholder="+91 XXXXX XXXXX" value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} />
              </div>
              <div className="cp-form-group">
        ...
        <div className="cp-hero-content">
          <FadeIn direction="none" delay={0.1}>
            <div className="cp-hero-badge">
              ...
              <span className="cp-badge-text">Careers at News4Bharat</span>
            </div>
          </FadeIn>
